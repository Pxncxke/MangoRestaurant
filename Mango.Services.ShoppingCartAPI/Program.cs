...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Mango.Service.ShoppingAPI", Version = "v1" });
    c.EnableAnnotations();
...
//builder.Services.AddDbContext<AplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString()))
